...
import { IGetathletestInputDTO, ILoginInputDTO, ILoginOutputDTO, ISignupInputDTO, ISignupOutputDTO, User, USER_ROLES } from "../models/User"
...
public getAthletes = async () => {
  ...
  const users = await this.userDatabase.getAthletes100m()
